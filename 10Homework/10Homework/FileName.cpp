...
void initialize() {
    ...
    sun.g = 1.0f; // 녹색
    sun.b = 0.0f; // 파란색
    sun.rotation_speed = 360.0f / (10.0f * 5.0f); // 10초 동안 360도 회전
    ...
    earth.g = 0.61f;
    earth.b = 0.83f;
    earth.rotation_speed = 360.0f / (10.0f * 5.0f); // 10초 동안 360도 회전
    earth.orbit_radius = 0.5f; // 태양으로부터의 거리
    earth.orbit_speed = 360.0f / (60.0f * 5.0f); // 1분 동안 360도 공전
    ...
    moon.g = 0.949f;
    moon.b = 0.0f;
    moon.rotation_speed = 360.0f / (3.0f * 5.0f); // 3초 동안 360도 회전
    moon.orbit_radius = 0.15f; // 지구로부터의 거리
    moon.orbit_speed = 360.0f / (3.0f * 5.0f); // 3초 동안 360도 공전
}
